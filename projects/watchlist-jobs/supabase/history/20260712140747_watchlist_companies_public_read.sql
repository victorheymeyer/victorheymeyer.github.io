...
--
-- version: 20260712140747
-- name:    watchlist_companies_public_read

create policy "Public read access" on public.watchlist_companies for select to anon, authenticated using (true);
